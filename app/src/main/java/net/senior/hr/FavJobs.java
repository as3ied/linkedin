...
public class FavJobs extends AppCompatActivity {
    RecyclerView rec;
    List<JobModel> jobs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_jobs);
        firebaseDatabase=FirebaseDatabase.getInstance();
        databaseReference=firebaseDatabase.getReference();
        rec=findViewById(R.id.fav_rec);
        jobs=new ArrayList();
        databaseReference.child("Favs").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener()
        {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                jobsAdapter.setOnViewListier(new JobsAdapter.OnViewListiner() {
                    ...
                    public void onViewClicked(int position) {
                        ...
                        databaseReference.child("Employer").child(jobs.get(position).getCompId()).addValueEventListener(new ValueEventListener() {
                         ...
                         intent=new Intent(FavJobs.this,ViewJobEmp.class);
                ...
                rec.setLayoutManager(new LinearLayoutManager(FavJobs.this));
                DividerItemDecoration dividerItemDecoration=new DividerItemDecoration(FavJobs.this,  DividerItemDecoration.VERTICAL);
