    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("CV").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                intrestedJobs=dataSnapshot.getValue(CVModel.class).getIntrestedJobs();
            }
...
intrestedJobs=new ArrayList();
        switch (view.getId()){
            case R.id.chk1:
                ...
                intrestedJobs.remove(ch1.getText().toString());
            ...
            case R.id.chk2:
                ...
                intrestedJobs.remove(ch2.getText().toString());
            ...
            case R.id.chk3:
                ...
                intrestedJobs.remove(ch3.getText().toString());
            ...
            case R.id.chk4:
                ...
                intrestedJobs.remove(ch4.getText().toString());
            ...
            case R.id.chk5:
                ...
                intrestedJobs.remove(ch5.getText().toString());
            ...
            case R.id.chk6:
                ...
                intrestedJobs.remove(ch6.getText().toString());
            ...
            case R.id.chk7:
                ...
                intrestedJobs.remove(ch7.getText().toString());
            ...
            case R.id.chk8:
                ...
                intrestedJobs.remove(ch8.getText().toString());
